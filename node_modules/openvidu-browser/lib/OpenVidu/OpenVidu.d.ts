...
export declare class OpenVidu {
     ...
     * @hidden
     */
    addAlreadyProvidedTracks(myConstraints: CustomMediaStreamConstraints, mediaStream: MediaStream): MediaStream;
    /**
     * @hidden
     */
    protected configureDeviceIdOrScreensharing(myConstraints: CustomMediaStreamConstraints, publisherProperties: PublisherProperties, resolve: any, reject: any): void;
    /**
     * @hidden
     */
